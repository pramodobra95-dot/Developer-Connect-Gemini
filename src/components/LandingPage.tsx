  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans selection:bg-brand-teal/30">
      ...
      <header className="relative py-20 lg:py-28 bg-[#00383f] border-b border-[#00282e] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-[#a5d2cb] text-[11px] font-mono select-none pt-1">
              Powered by <span className="text-[#4df5e2] font-black tracking-wide">BANTConfirm</span>
            </p>
      ...
      <footer className="bg-[#001c3d] text-white py-12">
        ...
        <div className="max-w-7xl mx-auto px-4 pt-6 text-[10px] text-slate-400 flex flex-col sm:flex-row justify-between gap-4 font-mono">
          <p>Tenant ID: {(import.meta as any).env?.AISTUDIO_APPLET_ID || "00533029-f460-47d1-a6a1-3922bcce0104"}</p>
          <p>© 2026 DeveloperConnect Inc. Compliant under Section 72 and Section 79 of the IT Act 2000.</p>
        </div>
      </footer>
